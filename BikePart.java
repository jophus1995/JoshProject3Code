...
/**
 *
 * BikePart is a class that contains information on bicycle parts and can store
 * the information in an array, and print it.
 *
 * @author Miles Spence
 */
public class BikePart implements Serializable {
    ...
    /**
     *
     * partName The name of the part. partNum The (ten digit) number associated
     * with the part. listPrice The price of the part when not on sale.
     * salesPrice The price of the part when on sale. onSale Signifies if the
     * part is on sale or not. quantity The number of bikeparts.
     */
    ...
    /**
     *
     * @return listPrice Gets the list price and returns it. It is only needed
     * for printLines.
     */
    ...
    /**
     *
     * @return Gets the correct price, factoring whether or not the bikepart is
     * on sale
     */
    ...
    /**
     *
     * @param onSale input from user which sets a bikeparts sale to true or
     * false
     */
    ...
    /**
     *
     * @return mod This is used to print out the actual information and not the
    ...
    public String toStringNameQuantity() {
        String dude = "" + partName + "," + quantity;
        return dude;
    }
